...
printf("\n\n\n%s:[test %d.]------------------------------------------------------------------------------------\n\n", __func__, test);\
    ...
    {                                                                         \
    stack_index(&calcs, 0, (int*)&typ, &temp);                                \
        if(typ == TYPE_BOOL && (temp.data.boolean == ( values[3].data.real operator values[5].data.real )))\
            printf("\n%s:[test %d.] %s was OK.\n", __func__, test, operation);\
        else                                                                  \
        {                                                                     \
            printf("\n%s:[test %d.] ERROR: stack value is (bool) %d and should be (bool) %d\n", __func__, test, temp.data.boolean, (values[3].data.real operator values[5].data.real));\
            break;                                                            \
        }                                                                     \
    }                                                                         \
    else                                                                      \
...
test++;                                                                       \
printf("\n\n\n%s:[test %d.]------------------------------------------------------------------------------------\n\n", __func__, test);\
    stack_push(&calcs, TYPE_REAL, &(values[2]));                              \
    stack_push(&calcs, TYPE_REAL, &(values[5]));                              \
    CALL_INTERPRET();                                                         \
    if(calcs.count==1)                                                        \
    {                                                                         \
    stack_index(&calcs, 0, (int*)&typ, &temp);                                \
        if(typ == TYPE_BOOL && (temp.data.boolean == ( values[2].data.real operator values[5].data.real )))\
            printf("\n%s:[test %d.] %s was OK.\n", __func__, test, operation);\
        else                                                                  \
        {                                                                     \
            printf("\n%s:[test %d.] ERROR: stack value is (bool) %d and should be (bool) %d\n", __func__, test, temp.data.boolean, (values[2].data.real operator values[5].data.real));\
            break;                                                            \
        }                                                                     \
    }                                                                         \
    else                                                                      \
